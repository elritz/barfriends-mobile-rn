...
import IllustrationDynamicLocation from '#/assets/images/dynamic/IllustrationDynamicLocation'
  ...
  const createTwoButtonAlert = () =>
    Alert.alert(
      ...
      `Location access is currently active ${capitalizeFirstLetter(
        rPerm?.locationBackground.status,
    ...
    <Box style={{marginBottom: insets.bottom}} className="mb-5 flex-1">
      ...
      <VStack space={'md'} className="mb-[2] w-full items-center">
        ...
        <Button
          size={'lg'}
          onPress={() =>
            !rPerm?.locationBackground.granted
              ? rPerm?.locationBackground.canAskAgain &&
                !rPerm.locationBackground.granted
