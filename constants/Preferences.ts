...
export const InitalStateStorage = {
	...
	preferences: {
		...
		theme: { name: 'Preference Theme Scheme', ...InitialStatePreferenceThemeColorScheme },
		notification: { name: 'Preference Notifications', ...NowPreferencePermissionInitialState },
		...
		...NowPreferencePermissionInitialState,
		systemunits: { name: 'Preference System Units', ...InitialStatePreferenceSystemsOfUnits },
	},
}
